                ...
                <div class="navbar-header">
                    <div class="top-left-part">
                        ...
                        <a class="logo" href="/">
                            ...
                            <b>
                                <!--This is light logo icon--><img src="{{URL::asset('plugins/images/logo-small.png')}}" alt="home" class="light-logo" />
                            </b>
                            <!-- Logo text image you can use text also -->
                            <span class="hidden-xs">
                                <!--This is light logo text--><img src="{{URL::asset('plugins/images/logo-text.png')}}" alt="home" class="light-logo" />
                            </span> </a>
                    </div>
                    <!-- /Logo -->
